...
html(class='no-js', lang='en')
  ...
  body(class='#{bodytag}', style={color: 'black', background: 'lightgrey'})
    block nv
      .bs-nv
        nav.navbar-default(role='navigation')
          #navbarCollapse.navbar-collapse
            ul.navbar-left.navbar-nav.nav
              li
                a(href='/') Home

    nav( style={display: 'block', background: '#42c51a', padding: '20px', margin: '30px'})
      block body
